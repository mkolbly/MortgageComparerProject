...
public class Bus
{
	private static final Bus myBus = new Bus();
	 ...
	 * actions.
	 * 
	 * @param enforcer Thread enforcer for register, unregister, and post
	 *           actions.
	 */
	...
	public void setEnforcer(ThreadEnforcer enforcer)
	{
		this.enforcer = enforcer;
	}
	 ...
	 * <p>
	 * If any subscribers are registering for types which already have a producer
	 * they will be called immediately with the result of calling that producer.
	 * <p>
	 * If any producers are registering for types which already have subscribers,
	 * each subscriber will be called with the value from the result of calling
	 * the producer.
	 * 
		...
		for (Class<?> type : foundProducers.keySet())
		{
			...
			if (previousProducer != null)
			{
				throw new IllegalArgumentException("Producer method for type " + type + " found on type "
					+ producer.target.getClass() + ", but already registered by type " + previousProducer.target.getClass()
					+ ".");
			}
	...
	public void unregister(Object object)
	{
		...
		for (Map.Entry<Class<?>, Set<EventHandler>> entry : handlersInListener.entrySet())
		{
			...
			{
				throw new IllegalArgumentException("Missing event handler for an annotated method. Is " + object.getClass()
					+ " registered?");
			}
	...
	/**
	 * Dispatches {@code event} to the handler in {@code wrapper}. This method is
	 * an appropriate override point for subclasses that wish to make event
	 ...
	 * producer is currently registered for {@code type}, this method will return
	 * {@code null}.
	 * 
